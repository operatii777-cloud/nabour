/// Auxiliary widgets: geocode sheet, universal search overlay, parking reservation.
...
class MapTapGeocodeSheetBody extends StatefulWidget {
  ...
  @override
  State<MapTapGeocodeSheetBody> createState() => MapTapGeocodeSheetBodyState();
}

class MapTapGeocodeSheetBodyState extends State<MapTapGeocodeSheetBody> {
...
class MapUniversalSearchOverlay extends StatefulWidget {
  ...
  State<MapUniversalSearchOverlay> createState() =>
      MapUniversalSearchOverlayState();
}
...
class MapUniversalSearchOverlayState extends State<MapUniversalSearchOverlay> {
...
class ParkingReservationSheet extends StatefulWidget {
  ...
  const ParkingReservationSheet({required this.spotId, required this.onReserved});

  @override
  ParkingReservationSheetState createState() => ParkingReservationSheetState();
}

class ParkingReservationSheetState extends State<ParkingReservationSheet> {
