/// Neighbor-related widget helpers extracted from map_screen.dart.
...
class NeighborProfileSheet extends StatefulWidget {
  ...
  @override
  State<NeighborProfileSheet> createState() => NeighborProfileSheetState();
}

class NeighborProfileSheetState extends State<NeighborProfileSheet> {
  String _address = '';
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemCount: kNeighborQuickMapEmojis.length,
              separatorBuilder: (_, __) => const SizedBox(width: 8),
              itemBuilder: (context, i) {
                final em = kNeighborQuickMapEmojis[i];
                return Material(
                  color: isDark ? Colors.grey.shade800 : Colors.grey.shade100,
